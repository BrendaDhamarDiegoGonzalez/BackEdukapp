<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark text-center">Alumnos</h1>
          </div><!-- /.col -->
          </div><!-- /.row -->
          </div><!-- /.container-fluid -->
        </div>
        ...
        <form method="post"  action="<?php echo $url."buscar"?>">
          <div class="form-group row ">
            ...
            <div>
              <input type="text" class="form-control" id="buscarAlumno2" name="buscarAlumno2" placeholder="Nombre del Alumno">
            </div>
            <div>
        ...
        <div class="card-body p-0">
          <div class="table-responsive">
            <table class="table m-0">
              ...
              <tbody>
                <?php
                $alumnos=ControladorConsultas::ctrAlumnos();
