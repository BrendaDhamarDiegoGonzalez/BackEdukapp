        ...
        <div class="card-body">
          <div class="row">
            <div class="col-6 col-md-3 text-center">
              <input type="text" class="knob" value="0" data-skin="tron" data-thickness="0.2" data-width="90"
                           data-height="90" data-fgColor="#3c8dbc" data-readonly="true">
              <div class="knob-label">Aspirantes registrados en el mes</div>
            </div>
            <!-- ./col -->
             <div class="col-6 col-md-3 text-center">
              ...
              <div class="knob-label">Centros educativos registrados en el mes</div>
             </div>
            <!-- ./col -->
          </div><!-- /.row -->
        </div><!-- /.card-body -->
